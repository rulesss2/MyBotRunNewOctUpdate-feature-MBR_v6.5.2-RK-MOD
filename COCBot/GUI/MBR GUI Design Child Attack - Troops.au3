...
$y += 18
	...
	$txtAddDelayIdlePhaseTimeMax = GUICtrlCreateInput($iAddIdleTimeMax, $x + 75, $y-2, 25, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	;GUICtrlSetState(-1,$GUI_DISABLE)
	GUICtrlSetLimit(-1, 999)
	$lbltxtAddDelayIdlePhaseSec = GUICtrlCreateLabel(GetTranslated(603, 6, "sec."), $x+107, $y, 20, 30)
	;GUICtrlSetState(-1,$GUI_DISABLE)
GUICtrlCreateGroup("", -99, -99, 1, 1)
GUICtrlCreateTabItem("")
