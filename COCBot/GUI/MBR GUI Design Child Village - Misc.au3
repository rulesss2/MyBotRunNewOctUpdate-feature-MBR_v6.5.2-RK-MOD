...
;	$y += 35
		...
		$chkCleanYard = _GUICtrlCreateCheckbox(GetTranslated(610,49, "Remove Obstacles"), $x + 215, $y + 4, -1, -1)
...
;	$y += 35
		...
		$chkGemsBox = _GUICtrlCreateCheckbox(GetTranslated(610,51, "Remove GemBox"), $x + 320, $y + 4, -1, -1)
...
$Group1 = GUICtrlCreateGroup("Treasury Collect", $x, $y, 440, 105)
	...
	$chkGoldTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 3, "Collect when Gold <"), $x + 190, $y + 10, 112, 17)
	...
	$chkFullGoldTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 4, "When full"), $x + 370, $y + 10, 67, 17)
