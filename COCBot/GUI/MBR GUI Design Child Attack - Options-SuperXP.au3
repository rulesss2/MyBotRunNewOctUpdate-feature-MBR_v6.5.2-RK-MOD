...
Local $x = 25, $y = 45, $xStart = 25, $yStart = 45
	...
	$grpSuperXP = GUICtrlCreateGroup(GetTranslated(700, 1, "Goblin XP"), $x - 20, $y - 20, 420, 305)
		$chkEnableSuperXP = _GUICtrlCreateCheckbox(GetTranslated(700, 2, "Enable Goblin XP"), $x, $y - 10, 102, 13)
		GUICtrlSetOnEvent(-1, "chkEnableSuperXP")
			$rbSXTraining = _GUICtrlCreateRadio(GetTranslated(700, 3, "Farm XP during troops Training"), $x, $y + 13, 176, 17)
			GUICtrlSetState(-1, $GUI_CHECKED)
			$lblLOCKEDSX = GUICtrlCreateLabel(GetTranslated(700, 13, "LOCKED"), $x + 210, $y + 13, 173, 50)
