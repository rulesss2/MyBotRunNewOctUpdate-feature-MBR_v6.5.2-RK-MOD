...
Func algorithm_AllTroops() ;Attack Algorithm for all existing troops
	...
	Switch $g_aiAttackStdDropSides[$g_iMatchMode]
		...
		Case 4 ;Classic Four Finger ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			...
			$nbSides = 5
	    Case 5 ;Multi Finger Attack~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~rulesss
			SetLog("Attacking Multi Finger Attack style RK MOD", $COLOR_INFO)
			$nbSides = 6
   ...
   ; Multi Finger Attack by rulesss and kychera
	...
	EndIf
	Setlog("- Activate Heroes Condition: " & $g_iActivateKQCondition, $COLOR_INFO)
	If $g_bActivateWardenCondition = 1 Then Setlog(" » Timed Warden in: " & $g_iDelayActivateW & "´s", $COLOR_INFO)

	If $g_iActivateKQCondition = "Manual" Or $g_bActivateWardenCondition = 1 Then
		...
		If $g_bCheckKingPower Then $g_aHeroesTimerActivation[$eHeroBarbarianKing] = TimerInit() ; will be use for Timed Activation Habilities
		If $g_bCheckQueenPower Then $g_aHeroesTimerActivation[$eHeroArcherQueen] = TimerInit() ; will be use for Timed Activation Habilities
		If $g_bCheckWardenPower Then $g_aHeroesTimerActivation[$eHeroGrandWarden] = TimerInit() ; will be use for Timed Activation Habilities
	EndIf
