...
$31 = GUICtrlCreatePic(@ScriptDir & '\Images\1.jpg', 2, 23, 442, 410, $WS_CLIPCHILDREN)  
	...
	GUICtrlCreateGroup(GetTranslated(108,1, "Smart Switch Accounts"), $x, $y, 430, 295)
		$x += 10
		$y += 20
			$chkEnableSwitchAccount = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkSwitchAccount")
				GUICtrlCreateLabel(GetTranslated(108,2, "Use Smart Switch Accounts"), $x + 17, $y, 152, 17)
		...
		$y += 35
			$chkCanUse[1] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,4, "Use Account 1 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[1] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[1] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[2] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,6, "Use Account 2 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[2] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[2] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)			
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[3] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,7, "Use Account 3 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[3] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[3] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		
		$y += 30
			$chkCanUse[4] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,8, "Use Account 4 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[4] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[4] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[5] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,9, "Use Account 5 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[5] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[5] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[6] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,10, "Use Account 6 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[6] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[6] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[7] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,11, "Use Account 7 with Profile :"), $x + 17, $y, 150, 17)
			$cmbAccount[7] = GUICtrlCreateCombo("", $z, $y - 2, 145, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL))
			$chkDonateAccount[7] = GUICtrlCreateCheckbox("", $w, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,5, "Donate only"), $w + 17, $y, 77, 17)
		$y += 30
			$chkCanUse[8] = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
				GUICtrlSetOnEvent(-1, "chkAccountsProperties")
				GUICtrlCreateLabel(GetTranslated(108,12, "Use Account 8 with Profile :"), $x + 17, $y, 150, 17)
