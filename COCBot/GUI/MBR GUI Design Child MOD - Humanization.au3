...
$chkUseBotHumanization = _GUICtrlCreateCheckbox(GetTranslated(698, 1, "Enable Bot Humanization"), 10, 25, 137, 17)
	GUICtrlSetOnEvent(-1, "chkUseBotHumanization")
	GUICtrlSetState(-1, $GUI_UNCHECKED)

$chkUseAltRClick = _GUICtrlCreateCheckbox(GetTranslated(698, 2, "Make ALL BOT clicks random"), 280, 25, 162, 17)
...
$y += 50
	...
	$humanMessage[0] = GUICtrlCreateInput(GetTranslated(628, 7, "Hello !"), $x + 75, $y + 25, 121, 21)
