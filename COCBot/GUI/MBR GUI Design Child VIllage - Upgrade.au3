...
;			GUICtrlSetFont(-1, 8)
	...
	$y += 20
		...
		$txtUpgrMinGold = GUICtrlCreateInput("250000", $x + 60, $y, 61, 17, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$y += 18
		...
		$txtUpgrMinElixir = GUICtrlCreateInput("250000", $x + 60, $y, 61, 17, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
			...
			GUICtrlSetLimit(-1, 7)
	$x -= 15
		GUICtrlCreateIcon ($pIconLib, $eIcnDark, $x, $y + 18, 15, 15)
		$UpgrMinDark = GUICtrlCreateLabel(GetTranslated(616,20, "Min. Dark") & ":", $x + 15, $y + 21, -1, -1)
		$txtUpgrMinDark= GUICtrlCreateInput("3000", $x + 75, $y + 18, 61, 17, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
...
#CE			;GUICtrlSetOnEvent(-1, "SlidemaxNbWall")
		...
		$UseGold = _GUICtrlCreateRadio(GetTranslated(617,7, "Use Gold"), $x + 25, $y + 16, -1, -1)
			_GUICtrlSetTip(-1, GetTranslated(617,8, "Use only Gold for Walls.") & @CRLF & GetTranslated(617,9, "Available at all Wall levels."))
			GUICtrlSetState(-1, $GUI_CHECKED)
			GUICtrlSetState(-1, $GUI_DISABLE)
		$UseElixir = _GUICtrlCreateRadio(GetTranslated(617,10, "Use Elixir"), $x + 25, $y + 34, -1, -1)
			...
			GUICtrlSetState(-1, $GUI_DISABLE)
		$UseElixirGold = _GUICtrlCreateRadio(GetTranslated(617,13, "Try Elixir first, Gold second"), $x + 25, $y + 52, -1, -1)
