...
Local $txtFull = GetTranslated(626,30, "Full")
	...
	$grpDeadBaseCollectors = GUICtrlCreateGroup(GetTranslated(626,1,"Collectors"), $x - 5, $y - 20, 420, 335)
		...
		$chkDeadBaseDisableCollectorsFilter = _GUICtrlCreateCheckbox(GetTranslated(626,32,"Disable Collector Filter"), $x+228, $y+12, 178, 13)
			GUICtrlSetState(-1, $GUI_UNCHECKED)
			_GUICtrlSetTip(-1, GetTranslated(626,33, "Excluding Collector Filter the bot consider DeadBase as LiveBase"))

	$y+=40
		$chkLvl6 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl7 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl8 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl9 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl10 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl11 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
	...
	$y+= 25
		$chkLvl12 = GUICtrlCreateCheckbox("", $x, $y, 13, 13)
   ...
   $x = 40
   $y = -2
        $chkDBMeetCollOutside = _GUICtrlCreateCheckbox(GetTranslated(2,107, "Check Collectors Outside"), $x + 250, $y + 90, -1, -1)
