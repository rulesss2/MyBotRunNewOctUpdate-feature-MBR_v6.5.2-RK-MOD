...
$hGUI_STATS_TAB_ITEM1 = GUICtrlCreateTabItem(GetTranslated(600,38,"Gain"))
    ...
    $x += 130
        $lblAPIKey = GUICtrlCreateLabel(GetTranslated(110,3,"API Key:"), $x-23, $y+5 , -1, 21, $SS_LEFT)
...
#include "../MOD/GUI Design - Stats Mod.au3"			; Adding GUI Profile Stats for SwitchAcc Mode
