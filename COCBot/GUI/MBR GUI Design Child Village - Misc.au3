...
Local $x = 15, $y = 45
	$grpControls = GUICtrlCreateGroup(GetTranslated(610,1, "Halt Attack"), $x - 10, $y - 20, 440, 100)
		$chkBotStop = GUICtrlCreateCheckbox("", $x - 5, $y, 13, 13)
...
Local $x = 15, $y = 150
	$grpMisc = GUICtrlCreateGroup(GetTranslated(610,40, "Rearm, Collect, Clear"), $x -10, $y - 20 , 440, 125)
		...
		$chkTrap = _GUICtrlCreateCheckbox(GetTranslated(610,41, "Rearm Traps && Reload Xbows and Infernos"), $x + 100, $y + 4, -1, -1)
	...
	$y += 35
		...
		$chkCollect = _GUICtrlCreateCheckbox(GetTranslated(610,43, "Collect Resources && Loot Cart"), $x + 100, $y + 4, -1, -1, -1)
	...
	$y += 35
		...
		$chkTombstones = _GUICtrlCreateCheckbox(GetTranslated(610,47, "Clear Tombstones"), $x + 100, $y + 4, -1, -1)
...
;	$y += 35
		...
		$chkCleanYard = _GUICtrlCreateCheckbox(GetTranslated(610,49, "Remove Obstacles"), $x + 220, $y + 4, -1, -1)
...
;	$y += 35
		...
		$chkGemsBox = _GUICtrlCreateCheckbox(GetTranslated(610,51, "Remove GemBox"), $x + 312, $y + 4, -1, -1)
...
$Group1 = GUICtrlCreateGroup(GetTranslated(800, 0, "Treasury Collect"), $x, $y, 440, 105)
	...
	GUICtrlCreateIcon($pIconLib, $eIcnGold, $x + 150, $y + 15, 24, 24)
	GUICtrlCreateIcon($pIconLib, $eIcnElixir, $x + 150, $y + 45, 24, 24)
	GUICtrlCreateIcon($pIconLib, $eIcnDark, $x + 150, $y + 75, 24, 24)

	$chkGoldTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 3, "Collect when Gold <"), $x + 180, $y + 10, 112, 17)
	...
	$txtMinGoldTrCollect = GUICtrlCreateInput("200000", $x + 270, $y + 17, 56, 21, BitOR($ES_CENTER,$ES_NUMBER))
	$chkFullGoldTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 4, "When full"), $x + 340, $y + 10, 67, 17)
	...
	$chkElxTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 5, "Collect when Elixir <"), $x + 180, $y + 38, 112, 17)
	GUICtrlSetOnEvent(-1, "chkResTrCollect")
	_GUICtrlSetTip(-1, GetTranslated(800, 54, "When your Village Elixir is below this value, it will collect Treasury"))
	$txtMinElxTrCollect = GUICtrlCreateInput("200000", $x + 270, $y + 47, 56, 21, BitOR($ES_CENTER,$ES_NUMBER))
	$chkFullElxTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 6, "When full"), $x + 340, $y + 38, 67, 17)
	GUICtrlSetOnEvent(-1, "chkFullResTrCollect")
	_GUICtrlSetTip(-1, GetTranslated(800, 55, "When your Elixir level in Treasury is full, it will colect it to empty Treasury"))

	$chkDarkTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 7, "Collect when Dark <"), $x + 180, $y + 68, 112, 17)
	GUICtrlSetOnEvent(-1, "chkResTrCollect")
	_GUICtrlSetTip(-1, GetTranslated(800, 56, "When your Village Dark is below this value, it will collect Treasury"))
	$txtMinDarkTrCollect = GUICtrlCreateInput("200000", $x + 270, $y + 77, 56, 21, BitOR($ES_CENTER,$ES_NUMBER))
	$chkFullDarkTrCollect = _GUICtrlCreateCheckbox(GetTranslated(800, 8, "When full"), $x + 340, $y + 68, 67, 17)
	GUICtrlSetOnEvent(-1, "chkFullResTrCollect")
