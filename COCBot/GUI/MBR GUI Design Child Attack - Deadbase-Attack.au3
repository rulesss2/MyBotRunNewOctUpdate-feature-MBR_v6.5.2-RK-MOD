...
Local $x = 25, $y = 40
	$grpDBAttack = GUICtrlCreateGroup(GetTranslated(624,1,"Attack with"), $x - 20, $y - 15, 145, 223)
		...
		$chkDBKingAttack = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x += 46
		$IMGchkDBQueenAttack=GUICtrlCreateIcon($pIconLib, $eIcnQueen, $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBQueenAttack = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x +=46
		$IMGchkDBWardenAttack=GUICtrlCreateIcon($pIconLib, $eIcnWarden, $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBWardenAttack = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
	    $y +=27
		$x -=92
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBDropCC = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x += 46
		$IMGchkDBLightSpell=GUICtrlCreateIcon($pIconLib, $eIcnLightSpell, $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBLightSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x +=46
		$IMGchkDBHealSpell=GUICtrlCreateIcon($pIconLib, $eIcnHealSpell, $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBHealSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
	    $y +=27
		$x -=92
		$IMGchkDBRageSpell=GUICtrlCreateIcon($pIconLib, $eIcnRageSpell, $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBRageSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x +=46
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBJumpSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x += 46
		$IMGchkDBFreezeSpell=GUICtrlCreateIcon($pIconLib, $eIcnFreezeSpell , $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBFreezeSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
	    $y +=27
		$x -=92
		$IMGchkDBCloneSpell=GUICtrlCreateIcon($pIconLib, $eIcnCloneSpell , $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBCloneSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x +=46
		$IMGchkDBPoisonSpell=GUICtrlCreateIcon($pIconLib, $eIcnPoisonSpell , $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBPoisonSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$x +=46
		$IMGchkDBEarthquakeSpell=GUICtrlCreateIcon($pIconLib, $eIcnEarthquakeSpell , $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBEarthquakeSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
		$y +=27
		$x -=92
		...
		_GUICtrlSetTip(-1, $txtTip)
		$chkDBHasteSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
		_GUICtrlSetTip(-1, $txtTip)
		$x +=46
		$IMGchkDBSkeletonSpell=GUICtrlCreateIcon($pIconLib, $eIcnSkeletonSpell , $x, $y, 24, 24)
			...
			_GUICtrlSetTip(-1, $txtTip)
		$chkDBSkeletonSpell = GUICtrlCreateCheckbox("", $x + 27, $y, 13, 13)
			_GUICtrlSetTip(-1, $txtTip)
...
Local $x = 10, $y = 268
	$grpTSAttackBeforeDB = GUICtrlCreateGroup(GetTranslated(624,32, "TH Snipe"),  $x - 5, $y - 20, 145, 84,$SS_CENTER)
		$chkTHSnipeBeforeDBEnable = _GUICtrlCreateCheckbox(GetTranslated(624,33, "Snipe TH External first") ,$x, $y - 5, -1, -1)
